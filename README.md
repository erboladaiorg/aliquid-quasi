...
![CI](https://github.com/erboladaiorg/aliquid-quasi/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@erboladaiorg/aliquid-quasi.svg?style=flat)](https://www.npmjs.com/package/@erboladaiorg/aliquid-quasi)
...
```
npm i @erboladaiorg/aliquid-quasi
```
...
- `opts.dependencies` - Set plugin dependencies to ensure correct load order
  ...
  Plugins and hooks are encapsulated together by folder and registered on the `fastify` instance which loaded the `@erboladaiorg/aliquid-quasi` plugin. For more information on how encapsulation works in Fastify, see: https://fastify.dev/docs/latest/Reference/Encapsulation/#encapsulation
